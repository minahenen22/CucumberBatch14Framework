...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchingApplication(){
        ConfigReader.readPrperties(Constants.CONFIGURATION_FILEPATH);
    ...
    //this methood will wait till element is clickable
    ...
    //will perform click on element using JS executor
    public static void jsClick(WebElement element){
        getJSExecutor().executeScript("arguments[0].click();", element);
    }
    //selecting the dropdown using text we can use indext / text
